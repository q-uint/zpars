...
pub fn ScannerWith(comptime config: Config) type {
    return struct {
        ...
        fn scanBackslash(self: *Self) void {
            if (self.isAtEnd()) {
        ...
        fn scanBracketExpr(self: *Self) void {
        ...
        fn scanOrdinaryChar(self: *Self) void {
            self.addToken(.char);
        }
