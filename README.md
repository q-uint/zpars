...
- **Grammar VM** — Bytecode virtual machine with disassembler and step-by-step tracing. Compiles any grammar to instructions and executes with backtracking and capture groups.
